<script>
    ...
    let sub = keyUpEvents.subscribe((value) => send(events.INPUT, { value }))
    ...
    $: matchState = (parent) => (state) => {
        return !parent ? matches(state) : matches({ [parent]: state })
    }
...
<div class="ui fluid form">
    ...
    <div class="ui field">
        <div
            ...
            class:error={matchResultsState(states.ERROR)}
            class:loading={matchResultsState(states.SEARCHING)}
        >
